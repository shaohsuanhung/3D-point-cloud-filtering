...
int main (int argc, char** argv)
{
  ...
  ros::init (argc, argv, "Down_Sample");
  ros::NodeHandle nh;
  // Create a ROS subscriber for the input point cloud
  ros::Subscriber sub = nh.subscribe<sensor_msgs::PointCloud2> ("passthroughfilter", 1, cloud_filter);

  // Create a ROS publisher for the output point cloud
  pub = nh.advertise<sensor_msgs::PointCloud2> ("/downsample_filter", 1);
